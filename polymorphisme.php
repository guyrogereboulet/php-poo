...
//Je oblige les classes qui veulent utiliser l'interface travailler à utiliser la méthode travailler
...
//J'implemente la méthode travailler avec le code ci-dessous
class Employe implements Travailleur {
...
class Etudiant implements Travailleur {
    ...
    public function travailler() {
        return "Je suis un étudiant qui travaille";
    }
}

$etudiant1 = new Etudiant ();
faireTravailler($etudiant1);ù
